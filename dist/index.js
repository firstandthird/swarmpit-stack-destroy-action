...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const destroyResponse = yield (0, node_fetch_1.default)(endpoint, {
                method: 'delete',
                headers
            });
            if (!destroyResponse.ok) {
                const destroyJSON = yield destroyResponse.json();
                return core.setFailed(`Destroy failed with status ${destroyResponse.status} and message: ${JSON.stringify(destroyJSON)}`);
            }
